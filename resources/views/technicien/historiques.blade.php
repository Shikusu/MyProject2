                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#reparationModal"
                                onclick="console.log(this.dataset);" data-id="{{ $intervention->id }}"
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var repairModal = document.getElementById('reparationModal');

            repairModal.addEventListener('show.bs.modal', function(event) {
                var button = event.relatedTarget; // The button that triggered the modal

                // Debug: Check the data being passed to the modal
                console.log('Affichage des données dans le modal :', button.dataset);

                // Fill modal fields with the data attributes
                document.getElementById('emetteur').value = button.getAttribute('data-emetteur');
                document.getElementById('localisation').value = button.getAttribute('data-localisation');
                document.getElementById('type_alerte').value = button.getAttribute('data-type_alerte');
                document.getElementById('message').value = button.getAttribute('data-message');
                document.getElementById('date_installation').value = button.getAttribute('data-date_installation');
                document.getElementById('derniere_maintenance').value = button.getAttribute('data-derniere_maintenance');
                document.getElementById('date_panne').value = button.getAttribute('data-date_panne');
            });
        });
