...
@section('content')
    <style>
        ...
        .pagination .page-item.active .page-link {
            background-color: #007BFF;  /* Fond bleu pour l'élément actif */
            border-color: #007BFF;  /* Bordure bleue pour l'élément actif */
            ...
            <div class="col-md-4">
                <div class="border-0 shadow-sm card custom-card">
                    <div class="card-body">
                        ...
                        <form action="{{ isset($piece) ? route('admin.pieces.update', $piece->id) : route('admin.pieces.admin.pieces.storeOrUpdate') }}" method="POST">
                            @csrf
                            @if (isset($piece))
                                @method('PUT')
                            @endif
